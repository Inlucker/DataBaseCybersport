...
MatchBL::MatchBL(int id, int t1, int t2, int w, int s, int c, int t, string d) :
    id(id), team1_id(t1), team2_id(t2), winner_id(w), studio_id(s), commentator_id(c), tournament_id(t), date(d)
{
